...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView,
        ...
        super(context,
            ...
            true);  // auto-requery
        setmSearchManager((SearchManager) mContext.getSystemService(Context.SEARCH_SERVICE));
...
//    });
	...
	public void setmSearchManager(SearchManager mSearchManager) {
		this.mSearchManager = mSearchManager;
	}
}
