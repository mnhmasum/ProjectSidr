...
public class SidraTextView extends TextView {

	public SidraTextView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(attrs);
	}
	
	public SidraTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
		
	}
	
	public SidraTextView(Context context) {
		super(context);
		init(null);
	}
