...
public class SidraButton extends Button {

	public SidraButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(attrs);
	}
	
	public SidraButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
		
	}
	
	public SidraButton(Context context) {
		super(context);
		init(null);
	}
