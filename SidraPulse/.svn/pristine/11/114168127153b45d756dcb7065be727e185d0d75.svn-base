...
public class StaffDirectoryAdapter extends BaseAdapter {

	private ArrayList<StaffDirectoryDepartmentsInfo> arrayList;
	private LayoutInflater mInflater;
	private Context context;

	public StaffDirectoryAdapter(Context context, ArrayList<StaffDirectoryDepartmentsInfo> arrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.txtViewTitle.setText(arrayList.get(position).getDepartmentName().toString());
